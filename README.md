...
- Paradigmas de Linguagem de Programação em Python (aplicado a dados e automação).
- Algoritmos e Estrutura de Dados I e II.
- Modelagem e Projetos de Bancos de Dados.
- Princípios de Interação Humano-Computador e Design UX.
